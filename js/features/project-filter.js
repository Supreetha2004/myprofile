...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Safety check
  if (!filterContainer || !projectsContainer || typeof projectsData === "undefined") {
    console.error("Filter: Missing elements or projectsData not loaded");
    return;
  }

  // ✅ Get unique categories (lowercase safe)
